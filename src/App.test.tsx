...
describe("App — default route", () => {
  ...
  it("renders the Layout header", () => {
    render(<App />);
    expect(
      screen.getByRole("heading", { name: /colours/i }),
    ).toBeInTheDocument();
  });
  ...
  it("renders all four nav links", () => {
    render(<App />);
    expect(
      screen.getByRole("link", { name: /^contrast$/i }),
    ).toBeInTheDocument();
    expect(
      screen.getByRole("link", { name: /^opacity$/i }),
    ).toBeInTheDocument();
    expect(
      screen.getByRole("link", { name: /^palette$/i }),
    ).toBeInTheDocument();
    expect(
...
describe("App — navigation", () => {
  ...
  it("navigates to PaletteGenerator when Palette is clicked", async () => {
    ...
    expect(
      screen.getByRole("heading", { name: /palette generator/i }),
    ).toBeInTheDocument();
  });
