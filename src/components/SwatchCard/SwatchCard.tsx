    ...
    <div className="card flex__item flex__item--12 flex__item--4-lg">
      ...
      <div className="card__body">
        ...
        <div className={styles.swatches}>
          <div
            className={styles.swatchSource}
            role="group"
            aria-label="Source"
            style={{ backgroundColor: sourceBg, color: sourceFg }}
          >
            <p className={styles.swatchValues}>
              <span>{rgb2Str(sourceColor.rgb)}</span>
              <br />
              <span>{hsl2Str(sourceColor.hsl)}</span>
              <br />
              <span>{hex2Str(sourceColor.hex)}</span>
            </p>
          </div>
          <div
            className={styles.swatchCompare}
            role="group"
            aria-label="Compare"
            style={{ backgroundColor: compareBg, color: compareFg }}
          >
            <p className={styles.swatchValues}>
              <span>{rgb2Str(color.rgb)}</span>
              <br />
              <span>{hsl2Str(color.hsl)}</span>
              <br />
