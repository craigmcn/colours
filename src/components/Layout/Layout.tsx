    ...
    <noscript>
      <div className="alert alert--danger alert--overlay" role="alert">
        ...
        <div className="alert__text">
          This site does not work without Javascript enabled.
        </div>
      </div>
    </noscript>
    ...
    <header className="header">
      ...
      <nav id="navigation" className="nav collapsed">
        <ul className="nav__list">
          ...
          <li className="nav__item">
            <NavLink className="nav__link" to="/opacity">
              Opacity
            </NavLink>
          </li>
          <li className="nav__item">
            <NavLink className="nav__link" to="/palette">
              Palette
            </NavLink>
          </li>
          <li className="nav__item">
            <NavLink className="nav__link" to="/blender">
              Blender
            </NavLink>
          </li>
        </ul>
