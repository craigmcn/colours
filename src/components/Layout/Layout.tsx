  ...
  <>
    <noscript>
      <div className="alert alert--danger alert--overlay" role="alert">
        <div className="alert__icon p-t-xs">
          <svg aria-hidden="true" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512" style={{ fontSize: '1.5em' }}>
            <g>
              ...
              <path fill="currentColor"
                d="M256 288c13.25 0 24-10.75 24-24v-112C280 138.8 269.3 128 256 128S232 138.8 232 152v112C232 277.3 242.8 288 256 288zM256 320c-17.67 0-32 14.33-32 32s14.33 32 32 32s32-14.33 32-32S273.7 320 256 320z"/>
            </g>
          </svg>
        </div>
        <div className="alert__text">This site does not work without Javascript enabled.</div>
      </div>
    </noscript>
    ...
    <header className="header">
      ...
      <h1>
        <NavLink className="header__link" to="/">Colours</NavLink>
      </h1>

      <nav id="navigation" className="nav collapsed">
        <ul className="nav__list">
          <li className="nav__item">
            <NavLink className="nav__link" to="/" end>Contrast</NavLink>
          </li>
          <li className="nav__item">
            <NavLink className="nav__link" to="/opacity">Opacity</NavLink>
          </li>
          <li className="nav__item">
            <NavLink className="nav__link" to="/palette">Palette</NavLink>
          </li>
          <li className="nav__item">
            <NavLink className="nav__link" to="/blender">Blender</NavLink>
          </li>
        </ul>
      </nav>
      ...
      <button
        id="menu-toggle"
        className="nav__control button button--default"
        type="button"
        aria-controls="navigation"
        aria-expanded="false"
        aria-label="Toggle navigation"
      >
        <span className="far fa-bars fa-fw" />
