        ...
        {props.type === "link2Body" ? (
          <>
            <p className="label--wcagA">
              WCAG A:{" "}
              <span className={props.results.A === "Pass" ? "pass" : ""}>
                {props.results.A}
              </span>
            </p>
            {props.results.A === "Fail" && (
              <p className="label--warn text--info">
                ...
                Use another method for differentiating links and text (e.g.,
                underline)
              </p>
            )}
          </>
          ...
          <>
            <p className="label--wcagAA">
              WCAG AA:{" "}
              <span className={props.results.AA === "Pass" ? "pass" : ""}>
                {props.results.AA}
              </span>
            </p>
            <p className="label--wcagAAA">
              WCAG AAA:{" "}
              <span className={props.results.AAA === "Pass" ? "pass" : ""}>
                {props.results.AAA}
              </span>
            </p>
          </>
